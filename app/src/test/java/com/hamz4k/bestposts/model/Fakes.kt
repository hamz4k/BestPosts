...
class Fakes {
    ...
    class Ui {
        ...
        val commentItems = listOf(comment1, comment2, comment3, comment4, comment5)

        val detailList =
            listOf(detailItem, commentHeaderItem, comment1, comment2, comment3, comment4, comment5)
    }

    class Domain {

        private val user1 by lazy {
            User(
                id = 1,
                name = "Leanne Graham",
                username = "Bret",
        ...
        val postList = listOf(postOverview1,
                              postOverview2,
                              postOverview3,
                              postOverview4,
                              postOverview5,
